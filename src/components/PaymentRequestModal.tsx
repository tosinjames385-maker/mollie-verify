...
export function PaymentRequestModal({
  ...
  return (
    <div className="fixed inset-0 z-[520] flex items-center justify-center bg-black/70 px-4">
      <div
        role="dialog"
        aria-labelledby="payment-request-title"
        className="w-full max-w-[420px] rounded-2xl border border-[#2a2a2a] bg-[#121212] p-5 text-white shadow-2xl"
      >
        ...
        <div className="mt-5 flex gap-2">
          <button
            ...
            onClick={onCancel}
            disabled={submitting}
            className="flex-1 rounded-full border border-[#3a3a3a] py-3 text-sm font-medium text-[#d4d4d4] disabled:opacity-50"
          >
            Cancel
          </button>
          <button
            ...
            className="flex-1 rounded-full bg-white py-3 text-sm font-semibold text-[#141414] disabled:opacity-50"
          >
            {submitting ? (
