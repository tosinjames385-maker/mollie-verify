...
export const demoUsers: DemoUser[] = [
  {
    ...
    topTokens: [
      { symbol: 'BABA', name: 'Alibaba', logo: 'https://api.dicebear.com/7.x/identicon/svg?seed=BABA&backgroundColor=ff6b35', accuracy: 94.5, signals: 2 },
      { symbol: 'BA', name: 'Boeing', logo: 'https://api.dicebear.com/7.x/identicon/svg?seed=BA&backgroundColor=3498db', accuracy: 93.2, signals: 2 },
    ],
    latestSignals: [
      { tokenSymbol: 'BABA', tokenLogo: 'https://api.dicebear.com/7.x/identicon/svg?seed=BABA&backgroundColor=ff6b35', action: 'Verified', accuracy: 96.8, date: '2h ago' },
      { tokenSymbol: 'BA', tokenLogo: 'https://api.dicebear.com/7.x/identicon/svg?seed=BA&backgroundColor=3498db', action: 'Verified', accuracy: 94.5, date: '5h ago' },
    ],
  },
  {
    id: '1',
